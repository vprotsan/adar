...
add_action( 'widgets_init', 'limoking_recent_portfolio_widget' );
if( !function_exists('limoking_recent_portfolio_widget') ){
	function limoking_recent_portfolio_widget() {
	...
	class Goodlayers_Recent_Portfolio extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Portfolio Widget','limoking'), 
				array('description' => esc_html__('A widget that show lastest portfolios', 'limoking')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				echo '<div class="limoking-recent-port-widget">';
