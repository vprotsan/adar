...
add_action( 'widgets_init', 'limoking_recent_post_widget' );
if( !function_exists('limoking_recent_post_widget') ){
	function limoking_recent_post_widget() {
	...
	class Goodlayers_Recent_Post extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Post Widget','limoking'), 
				array('description' => esc_html__('A widget that show lastest posts', 'limoking')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				...
				while($query->have_posts()){ $query->the_post();
					...
					echo '<div class="recent-post-widget-info">' . limoking_get_blog_info(array('date'), false) . '</div>';
					echo '</div>';
