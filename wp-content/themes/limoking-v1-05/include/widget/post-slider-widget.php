...
add_action( 'widgets_init', 'limoking_post_slider_widget' );
if( !function_exists('limoking_post_slider_widget') ){
	function limoking_post_slider_widget() {
	...
	class Goodlayers_Post_Slider extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Post Slider Widget','limoking'), 
				array('description' => esc_html__('A widget that show lastest posts in slider format', 'limoking')));  
		}
