...
add_action( 'widgets_init', 'limoking_recent_comment_widget' );
if( !function_exists('limoking_recent_comment_widget') ){
	function limoking_recent_comment_widget() {
	...
	class Goodlayers_Recent_Comment extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Comment Widget','limoking'), 
				array('description' => esc_html__('A widget that show lastest comment', 'limoking')));  
		}
		...
		function widget( $args, $instance ) {
			...
			echo '<div class="limoking-recent-comment-widget">';
			foreach( $recent_comments as $recent_comment ){
					...
					echo esc_html__('Commented On', 'limoking') . ' ';
