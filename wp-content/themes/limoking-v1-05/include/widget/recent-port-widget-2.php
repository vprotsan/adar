...
add_action( 'widgets_init', 'limoking_recent_portfolio2_widget' );
if( !function_exists('limoking_recent_portfolio2_widget') ){
	function limoking_recent_portfolio2_widget() {
	...
	class Goodlayers_Recent_Portfolio2 extends WP_Widget{
		...
		function __construct() {
			parent::__construct(
				...
				esc_html__('Goodlayers Recent Portfolio 2 Widget','limoking'), 
				array('description' => esc_html__('A widget that show lastest portfolios in 2nd style', 'limoking')));  
		}
		...
		function widget( $args, $instance ) {
			...
			if($query->have_posts()){
				echo '<div class="limoking-recent-port2-widget">';
