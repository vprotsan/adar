(function($){
	...
	$.fn.limoking_alert = function(options){
		...
		$(this).each(function(){
			...
			var alert_box = $('<div class="limoking-alert-wrapper"></div>');
	...
	// create the alert message
	$.fn.limoking_confirm = function(options){
		...
		$(this).each(function(){
			...
			var confirm_button = $('<span class="limoking-button confirm-yes">Yes</span>');
			var decline_button = $('<span class="limoking-button confirm-no">No</span>');
		
			var confirm_box = $('<div class="limoking-confirm-wrapper"></div>');
