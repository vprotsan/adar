...
== Description ==
A Google Maps plugin for WordPress to create unlimited locations, maps and display google map on any page using short codes. Perfectly responsive maps, Multi-lingual and multisite supported made it most advanced WordPress plugin ever. This plugin, automatically calculates exact latitude and longitude values when provided with address.
...
* Display a infowindow message to any location.
...
* Demo : [Google Maps Pro Plugin Live Demo](http://wpgmp.flippercode.com/)
...
<strong>[Google Maps Pro Plugin Live Demo](http://www.flippercode.com/product/wp-google-map-pro/)</strong> |
<strong>[Support Forums](http://www.flippercode.com/forums/)</strong> |
<strong>[WP Google Map Documentation](http://guide.flippercode.com/googlemaps/)</strong> |
<strong>[FAQ](https://wordpress.org/plugins/wp-google-map-plugin/faq/)</strong>
...
== Screenshots ==
1. Display Multiple locations on single map with multiple markers.
2. An easy interface to add Locations. Assign catgory for custom marker image.  
3. Automatically calculates exact latitude and longitude values when provided with address.
4. Take control on Google Map Default options with just on click.
5. Create your awesome google maps with easy to use options. Assign multiple locations to the map here.
6. Display all your locations in Core WordPress format. Easy to manage locations just like you do for posts/pages.
7. Display all your maps in Core WordPress format. Easy to manage maps just like you do for posts/pages.
8. Position google maps controls where you want. 
9. Enable Streetview and it's Settings.
...
Yes, You can click on [WP Google Map Pro Guide](http://guide.flippercode.com/googlemaps/) and you will get all documentation with proper steps and video tutorials.
...
== Links ==
[Advanced Google Maps Plugin](http://codecanyon.net/item/advanced-google-maps-plugin-for-wordpress/5211638) |
[Live Demo](http://www.flippercode.com/product/wp-google-map-pro/) |
[Support Forums](http://www.flippercode.com/forums)
[WP Google Map Documentation](http://guide.flippercode.com/googlemaps/) |
