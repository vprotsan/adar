<?php
/*
Plugin Name: Goodlayers Function
Plugin URI: 
Description: A plugin including function, shortcode and some widget to use with limoking Theme ( This plugin functionality might not working properly on another theme )
Version: 1.0
Author: Goodlayers
	...
	function gdlr_init_page_feature() {
		...
		register_taxonomy(
			'page_category', array("page"), array(
				'hierarchical' => true,
				'label' => __('Page Categories', 'limoking'), 
				'singular_label' => __('Page Category', 'limoking'), 
...
// 	if( $key != 'gdlr_code' && $key != 'gdlr_space' ){
// 		echo "'$key' => '$value', ";
// 	}
// }
...
add_filter('limoking_the_content', 'gdlr_fix_shortcodes', 9);
add_filter('limoking_the_content', 'gdlr_fix_shortcodes_callback', 11);
...
{	title: 'Gallery', 
	value: '[gallery ids="0" columns="4" link="file" caption="yes" size="thumbnail" ]'
}, 
{	title: 'Heading Tag', 
...
{	title: 'Icon', 
	value: '[gdlr_icon type="icon-adjust" color="#353535" size="15px" text_size="13px" text="" padding_right="" text_color="" link="" target="" ]'
}, 
{	title: 'Image Link', 
