<?php
	...
	*/
	...
	if( is_admin() ){ add_action('after_setup_theme', 'limoking_create_portfolio_options'); }
	if( !function_exists('limoking_create_portfolio_options') ){
	
		function limoking_create_portfolio_options(){
	...
	add_filter('limoking_page_builder_option', 'limoking_register_portfolio_item');
	if( !function_exists('limoking_register_portfolio_item') ){
		function limoking_register_portfolio_item( $page_builder = array() ){
			...
			$page_builder['content-item']['options']['portfolio'] = array(
				...
				'options'=>array_merge(limoking_page_builder_title_option(true), array(					
					'category'=> array(
						...
						'type'=> 'multi-combobox',
						'options'=> limoking_get_term_list('portfolio_category'),
					...
					'tag'=> array(
						...
						'type'=> 'multi-combobox',
						'options'=> limoking_get_term_list('portfolio_tag'),
					...
					'portfolio-layout'=> array(
						...
						'options'=> array(
							...
							'masonry-style-1' => __('Masonry Style 1 ( Only Modern Portfolio )', 'gdlr-portfolio'),
							'masonry-style-2' => __('Masonry Style 2 ( Only Modern Portfolio )', 'gdlr-portfolio'),
					...
					'thumbnail-size-featured'=> array(
						'title'=> __('Featured Thumbnail Size' ,'gdlr-portfolio'),
						'type'=> 'combobox',
						'options'=> limoking_get_thumbnail_list(),
						'wrapper-class'=> 'portfolio-layout-wrapper masonry-style-1-wrapper masonry-style-2-wrapper',
						'description'=> __('For "Masonry" layout','gdlr-portfolio')
					),	
					'orderby'=> array(
